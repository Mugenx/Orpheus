<?php
	...
	class DisplayUserInfo_model extends CI_Model {
		...
		public function get_userinfo($studentNumber){
			...
			$this->db->select('ProgramName, StudentNumber, UserName, FirstName, LastName, Email, Program, Enabled, LoanAdmin, Approver, Year, Notes');
