<?php
	class insertEquipment{
		...
		function __construct($EquipmentTag, $Name, $SerialNumber, $Category, $Quantity, $EquipmentProgram, $LoanDuration, $Status, $AuthorizationRequired, $Year, $Cost, $DateInService, $EquipmentVisible, $EquipmentDeleted, $Notes, $Inventoried, $InventoriedDate){
