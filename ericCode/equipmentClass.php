<?php
	class Equipment{
		...
		function __construct($EquipmentRecordID, $EquipmentTag, $Name, $SerialNumber, $Category, $Quantity, $EquipmentProgram, $LoanDuration, $Status, $AuthorizationRequired, $Year, $Cost, $DateInService, $EquipmentVisible, $EquipmentDeleted, $Notes, $Inventoried, $InventoriedDate){
